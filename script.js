document.addEventListener("DOMContentLoaded", function () {
    ...
    async function fetchUserDetails(username) {
      try {
        ...
        // Check if matchedUser and submitStats are available
        if (
          !parsedData.data.matchedUser ||
          !parsedData.data.matchedUser.submitStats
        ) {
          throw new Error("User not found or no submission stats available");
        }
    ...
    // Update the progress for each difficulty
